  ...
  Widget _buildNormalHeader() {
    return GlassHeader(
      ...
      actions: [
        ...
        GlassHeader.iconBtn(
          Icons.edit_square,
          onTap: _sessions.isEmpty ? null : _toggleSelectionMode,
        ),
      ],
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          const Text(
            '🌸',
            style: TextStyle(fontFamily: 'MapleMono', fontSize: 48),
          ),
...
Route _chatRoute(ChatSession session) {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) =>
        ChatScreen(session: session, heroTag: 'avatar_${session.id}'),
